...
const QMetaObject MapMarker::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_MapMarker.data,
      qt_meta_data_MapMarker,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *MapMarker::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_MapMarker.stringdata0))
        return static_cast<void*>(const_cast< MapMarker*>(this));
