...
class RefboxReceiver
{
    public:
        /**
         * Ctor.
         */
        RefboxReceiver(const ros::NodeHandle &nh);
    ...
    private:
         ...
         * Copy Ctor.
         */
        RefboxReceiver(const RefboxReceiver &other);

        /**
         * Assignment operator
         */
        RefboxReceiver &operator=(const RefboxReceiver &other);
    ...
    private:
         ...
         */
        std::shared_ptr<protobuf_comm::ProtobufBroadcastPeer> peer_public_;

        /**
         * The interface to the Protobuf Broadcast peer to communicate with Team.
         */
        std::shared_ptr<protobuf_comm::ProtobufBroadcastPeer> peer_team_;
