...
if("TRUE" STREQUAL "TRUE")
  set(pr2_description_SOURCE_PREFIX /home/viki/school/PTT7/new-launch/ESA-PROJ/esa_proj/src/fontys_at_work/denpendencies/pr2_common/pr2_description)
  set(pr2_description_DEVEL_PREFIX /home/viki/school/PTT7/new-launch/ESA-PROJ/esa_proj/devel)
  ...
  set(pr2_description_INSTALL_PREFIX /home/viki/school/PTT7/new-launch/ESA-PROJ/esa_proj/install)
...
if(NOT "" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'pr2_description' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/viki/school/PTT7/new-launch/ESA-PROJ/esa_proj/src/fontys_at_work/denpendencies/pr2_common/pr2_description/${idir}'.  Ask the maintainer 'Devon Ash <dash@clearpathrobotics.com>' to fix it.")
    endif()
