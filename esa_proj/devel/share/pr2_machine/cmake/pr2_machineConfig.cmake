...
if("TRUE" STREQUAL "TRUE")
  set(pr2_machine_SOURCE_PREFIX /home/viki/school/PTT7/new-launch/ESA-PROJ/esa_proj/src/fontys_at_work/denpendencies/pr2_common/pr2_machine)
  set(pr2_machine_DEVEL_PREFIX /home/viki/school/PTT7/new-launch/ESA-PROJ/esa_proj/devel)
  ...
  set(pr2_machine_INSTALL_PREFIX /home/viki/school/PTT7/new-launch/ESA-PROJ/esa_proj/install)
...
if(NOT "" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'pr2_machine' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/viki/school/PTT7/new-launch/ESA-PROJ/esa_proj/src/fontys_at_work/denpendencies/pr2_common/pr2_machine/${idir}'.  Ask the maintainer 'Devon Ash <dash@clearpathrobotics.com>' to fix it.")
    endif()
